            ...
            <div className="w-2/5 h-3/5 mt-24 bg-white box-border p-16 flex flex-col items-center shadow-lg shadow-black">
                ...
                <div className="flex flex-col gap-8 mt-6 w-full items-center">
                    <div className="userNameLogin">
                        <input type="text" className="w-auto h-12 text-black px-3 bg-gray-200 border-none rounded-md placeholder:text-gray-600"  placeholder="UserName" onChange={(e) => handleOnChangeInput(e, 'userName')}/>
                    </div>
                    <div className="userNameLogin">
                        <input type="password" className="w-auto h-12 text-black px-3 bg-gray-200 border-none rounded-md placeholder:text-gray-600" placeholder="Password" onChange={(e) => handleOnChangeInput(e, 'password')}/>
                    </div>
                </div>
                <div className="w-3/5 flex justify-between mt-6">
                    <div className=" w-auto px-2 h-9 border text-center flex justify-center items-center rounded-md text-lg font-semibold hover:text-black bg-gray-200 border-black cursor-pointer  hover:bg-gray-400">
                        Login
                    </div>
